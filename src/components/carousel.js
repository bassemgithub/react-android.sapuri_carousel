  ...
  render() {
    ...
    return (
      <OwlCarousel className='owl-theme' items='1' loop autoplay autoplayTimeout='2000'>
        ...
        <div className="card">
          <img className="card-img-top" src={images.img2} alt="Card image" />
          <div className="card-body">
            <h4 className="card-title">Couscous</h4>
        ...
        <div className="card">
          <img className="card-img-top" src={images.img3} alt="Card image" />
          <div className="card-body">
        ...
        <div className="card">
          <img className="card-img-top" src={images.img5} alt="Card image" />
          <div className="card-body">
        ...
        <div className="card">
          <img className="card-img-top" src={images.img6} alt="Card image" />
          <div className="card-body">
            <h4 className="card-title">John Doe</h4>
            <p className="card-text">Some example text some example text. John Doe is an architect and engineer</p>
          </div>
